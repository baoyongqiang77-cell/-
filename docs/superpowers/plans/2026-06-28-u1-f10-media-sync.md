...
- [x] Add failing metadata and Alembic tests for `media_files`.
...
- [x] Run the focused persistence tests and confirm RED.
...
- [x] Add Alembic revision `20260628_0010`.
...
- [x] Run service tests and confirm RED.
...
- [x] Implement `apps/api/app/media_sync.py`.
...
- [x] Add routes in `apps/api/app/main.py`.
...
- [x] Run static and focused verification.
